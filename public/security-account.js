...
(function(root,factory){
 ...
 const translations={es:{exit:'Salir',pwf_why:'Ingresaste con una contraseña temporal. Elegí una personal de 15 a 128 caracteres para continuar.',pwf_short:'Usá entre 15 y 128 caracteres. Podés usar una frase y espacios.',pass_short:'Usá entre 15 y 128 caracteres; para un restablecimiento, también se admite tenis.',fix_change_password_for:'¿Asignar una contraseña temporal a {n}? Se cerrarán sus sesiones y deberá cambiarla al entrar.',ui36_text_213:'Contraseña temporal (15–128) o tenis',p2_temporary:texts.es.temporary,p2_revoke_keys:texts.es.revokeKeys,p2_reset_done:texts.es.resetDone},en:{exit:'Sign out',pwf_why:'You signed in using a temporary password. Choose a personal password of 15 to 128 characters to continue.',pwf_short:'Use 15 to 128 characters. Passphrases and spaces are allowed.',pass_short:'Use 15 to 128 characters; tenis is also allowed for a reset.',fix_change_password_for:'Assign a temporary password to {n}? Their sessions will be closed and they must change it at sign-in.',ui36_text_213:'Temporary password (15–128) or tenis',p2_temporary:texts.en.temporary,p2_revoke_keys:texts.en.revokeKeys,p2_reset_done:texts.en.resetDone}};
