...
function renderTutorial(){
 ...
 const text=document.createElement('p');text.className='guide-copy';text.textContent=t('guide_'+step+'_body');
 ...
 dialog.append(progress,title,text,error,actions);ov.appendChild(dialog);title.focus();
}
