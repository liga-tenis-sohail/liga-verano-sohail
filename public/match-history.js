...
(function(global){
 ...
 function badge(m,name){
  ...
  if(k==='np')return '<span class="badge badge-tag">'+e(m.npReason==='injury'?(LANG==='en'?'Injury · not played':'Lesión · no jugado'):t('mh_np'))+'</span>';
